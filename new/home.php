<?php  require_once('config/instantiated_files.php');
       ...
       $all_orders = get_all_customer_orders($customer_id);
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-6">
                            ...
                            <div class="checkout__order">
                                ...
                                <p class="alert alert-success">You can send us a message on whatsapp after successful payment. <a target="_blank" style="color: green;" href="https://wa.me/+447999372481?text=My%20name%20is%20<?php echo $fullname; ?>%20and%20I%20have%20just%20made%20payment%20on%20your%20site"><strong>Click Here</strong></a></p>

                                  <?php   if(   isset($_SESSION['cart'])  && (count($_SESSION['cart']) > 0 )   ){?>
                                         <a href="complete_order.php" style="color:red; font-size: 18px;">You have a current list in your cart awaiting payment</a><hr>
                                  <?php } ?>
                                <h4>All Orders</h4>
                                <!-- <div class="checkout__order__products">Products <span>Total</span></div> -->
                                <?php if($all_orders == null){
                                ...
                                foreach($all_orders as $each_order){?>
                                    <tr>
                                    <th scope="row"><?php echo $c; ?></th>
                                    <td><?php echo $each_order['invoice_no']; ?></td>
                                    <td><?php echo $each_order['payment_status'] == 1 ? 'positive': 'pending'; ?></td>
                                    <td><?php echo $each_order['delivery_status'] == 1 ? 'positive': 'pending'; ?></td>
