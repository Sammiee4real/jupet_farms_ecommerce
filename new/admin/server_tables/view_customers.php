...
$columns = array(
    ...
    //         return $product_name.'<br><img width="90" height="50" src="./'.$imgpath.'"><a style="margin:10px;" href="edit_product.php?pid='.$d.'" class="btn btn-sm btn-primary">Edit Product</a><br>';
    //     }
    //  ),
