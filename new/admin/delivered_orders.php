<?php require_once('../config/admin_instantiated_files.php');
       ...
       $global_delivered_orders = get_global_customer_delivered_orders();
?>
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">View Delivered Orders</h6>
              <p class="mb-4">You can view your all Delivered orders here</p>
                                ...
                                <?php
                                  ...
                                  while($data = mysqli_fetch_assoc($query)) { 
                                     ...
                                     ?>
                                      ...
                                      <td><span href="#" class="badge badge-primary badge-sm" data-toggle="modal">delivered order</span></td>
                                    ...
                                    <div class="modal-body">
                                      <p><strong>Are you sure you want to approve this order?</strong><br>
                                        <a href="complete_order.php" style="color: green;">YES, Please approve</a> &nbsp;
