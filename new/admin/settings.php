<?php  require_once('../config/admin_instantiated_files.php');
       ...
       if(isset($_POST['cmd_update'])){
            ...
            $update_profile =  update_profile($uid,$fname,$lname);
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <h6 class="m-0 font-weight-bold text-primary">Settings</h6>
              <p class="mb-4">Change Settings here</p>
              ...
              <h6 class="m-0 font-weight-bold text-primary">Change Webmail/Phone</h6>
              ...
              <div class="form-group">
              <label>Phone</label>                                
              <input type="number" required="" class="form-control form-control-sm" value="" id="phone" name="phone">      
              </div>

              <input type="submit" value="Change Webmail" name="cmd_resetp" class="btn btn-danger btn-sm btn-block"/>
              </a>
              </form>
