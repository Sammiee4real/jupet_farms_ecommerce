                                ...
                                <?php
                                  ...
                                  while($data = mysqli_fetch_assoc($query)) { 
                                     ...
                                     ?>
                                      ...
                                      <td><?php echo $data['payment_status'] == 1 ? 'positive': 'pending'; ?></td>
                                      <td><?php echo $data['delivery_status'] == 1 ? 'positive': 'pending'; ?></td>
                                      ...
                                      <td><a href="#" class="btn btn-primary btn-sm" data-target="#approve<?php echo $data['invoice_no']; ?>" data-toggle="modal">complete order</a></td>
                                    ...
                                    <div class="modal-body">
                                      <p><strong>Are you sure you want to complete this order?</strong><br>
                                        <a href="#" class="mark_as_completed" id="<?php echo $data['invoice_no']; ?>" style="color: green;">YES, Please mark as completed</a> &nbsp;
