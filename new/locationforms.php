...
?>
    <br/>
<form action="" method="post">
<input type="hidden" name="melo"  value="<?php echo $melo;?>" />
    <input type="hidden"  name="form_id"  value="<?php echo $fid;?>" />
    <input type="hidden" name="user"  value="<?php echo $_SESSION['email'];?>" />
    <input type="submit" disabled name="rebuild" id="rebuild" value="Rebuild" class="btn btn-success">
    </form>
