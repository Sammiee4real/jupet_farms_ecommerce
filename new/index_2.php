...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> support@jupetfarmfredddsh.com</li>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> support@jupetfarmfrddesh.com</li>
                   ...
                   <!--  <div class="hero__search">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
                        <div class="hero__text">
                            ...
                            <h2>Chicken, Turkey <br>Goat Meat <br />100% Natural</h2>
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-6 col-md-4 col-sm-6 mix vegetables fresh-meat">
                    <div class="featured__item">
